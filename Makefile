...
SRCS = $(SRCS_PATH)/main.c $(TREE_PATH)/create_tree.c $(REDIRECTION_PATH)/redirections.c $(TREE_PATH)/ast_utils.c $(TREE_PATH)/tree_execution.c $(SRCS_PATH)$(ENV_PATH)/env.c $(SRCS_PATH)$(ENV_PATH)/init.c \
		...
		$(SRCS_PATH)$(BUILTINS_PATH)/ft_cd.c $(SRCS_PATH)$(BUILTINS_PATH)/ft_cd_utils.c $(SRCS_PATH)$(BUILTINS_PATH)/ft_echo.c \
		...
		$(SRCS_PATH)$(UTIL_PATH)/ft_split_quoted_utils.c $(SRCS_PATH)$(UTIL_PATH)/ft_interpret_str.c $(SRCS_PATH)$(UTIL_PATH)/ft_interpret_str_util.c $(FD_PATH)/fd_utils.c $(FD_PATH)/fd.c $(REDIRECTION_PATH)/heredoc_utils.c $(TREE_PATH)/ast.c \
		...
		$(REDIRECTION_PATH)/heredoc_utils2.c $(TREE_PATH)/ast_utls2.c $(SRCS_PATH)$(UTIL_PATH)/main_utils2.c
